...
let EfiAuthService = EfiAuthService_1 = class EfiAuthService {
    ...
    async getAccessToken() {
        if (!this.config.isConfigValid) {
            throw new common_1.ServiceUnavailableException('Efí não configurada. Verifique EFI_CLIENT_ID, EFI_CLIENT_SECRET, certificado e EFI_PAGADOR_CHAVE.');
        }
        const now = Date.now();
        const buffer = 10_000;
    ...
    async fetchNewToken() {
        ...
        try {
            ...
            if (response.status !== 200) {
                ...
                const errorDesc = body?.error_description || body?.error || JSON.stringify(body);
                this.logger.error(`Falha ao obter token Efí: status=${response.status} error="${errorDesc}"`);
                if (response.status === 401) {
                    throw new common_1.InternalServerErrorException(`Efí auth 401: ${errorDesc}. ` +
                ...
                throw new common_1.InternalServerErrorException(`Efí auth falhou: ${response.status} — ${errorDesc}`);
            }
            ...
            if (e instanceof common_1.InternalServerErrorException ||
                e instanceof common_1.ServiceUnavailableException) {
                throw e;
            }
            const message = e instanceof Error ? e.message : 'Erro desconhecido na autenticação';
            this.logger.error(`Erro de conexão com Efí: ${message}`);
            throw new common_1.InternalServerErrorException(`Erro de conexão com Efí: ${message}. ` +
...
let EfiConfigService = EfiConfigService_1 = class EfiConfigService {
    ...
    onModuleInit() {
        ...
        this._pagadorChave = this.configService.get('EFI_PAGADOR_CHAVE', '');
        this._certBuffer = this.loadCertBuffer();
        this._isConfigValid = this.validate();
        this.logger.log(`Efí configurada: ambiente=${this._ambiente}, baseUrl=${this._baseUrl}, ` +
    ...
    validate() {
        ...
        if (!this._certBuffer || this._certBuffer.length === 0) {
            errors.push('Certificado .p12 não carregado (configure EFI_CERT_BASE64 ou EFI_CERT_PATH)');
        }
        if (!this._pagadorChave) {
            errors.push('EFI_PAGADOR_CHAVE não configurada (obrigatória para PIX-out)');
        }
        if (errors.length > 0) {
            this.logger.error(`Configuração Efí INCOMPLETA — PIX não funcionará:\n  - ${errors.join('\n  - ')}`);
            return false;
        }
        return true;
    }
    loadCertBuffer() {
        ...
        if (base64) {
            ...
            this.logger.debug(`Certificado Efí carregado via EFI_CERT_BASE64 (${buf.length} bytes)`);
            return buf;
        }
        ...
        if (certPath) {
            ...
            this.logger.debug(`Certificado Efí carregado de: ${resolved} (${buf.length} bytes)`);
            return buf;
        }
        return Buffer.alloc(0);
    }
...
var _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.EfiPixController = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const api_key_guard_1 = __webpack_require__(/*! ../common/guards/api-key.guard */ "./src/common/guards/api-key.guard.ts");
...
let EfiPixController = class EfiPixController {
    constructor(pix) {
        this.pix = pix;
    }
    async sendPix(dto) {
...
exports.EfiPixController = EfiPixController;
__decorate([
    (0, common_1.Post)('send'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof send_pix_dto_1.SendPixDto !== "undefined" && send_pix_dto_1.SendPixDto) === "function" ? _b : Object]),
    __metadata("design:returntype", Promise)
], EfiPixController.prototype, "sendPix", null);
__decorate([
    (0, common_1.Get)('status/:idEnvio'),
    __param(0, (0, common_1.Param)('idEnvio')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], EfiPixController.prototype, "getPixStatus", null);
__decorate([
    (0, common_1.Get)('balance'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], EfiPixController.prototype, "getBalance", null);
exports.EfiPixController = EfiPixController = __decorate([
    (0, common_1.Controller)('api/pix'),
    (0, common_1.UseGuards)(api_key_guard_1.ApiKeyGuard),
    __metadata("design:paramtypes", [typeof (_a = typeof efi_pix_service_1.EfiPixService !== "undefined" && efi_pix_service_1.EfiPixService) === "function" ? _a : Object])
], EfiPixController);
...
/***/ "./src/efi/efi-webhook.controller.ts":
/*!*******************************************!*\
  !*** ./src/efi/efi-webhook.controller.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var EfiWebhookController_1;
var _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.EfiWebhookController = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const express_1 = __webpack_require__(/*! express */ "express");
const firestore_rest_service_1 = __webpack_require__(/*! ../firebase-rest/firestore-rest.service */ "./src/firebase-rest/firestore-rest.service.ts");
let EfiWebhookController = EfiWebhookController_1 = class EfiWebhookController {
    constructor(firestore) {
        this.firestore = firestore;
        this.logger = new common_1.Logger(EfiWebhookController_1.name);
    }
    healthCheck() {
        return { status: 'ok', service: 'efi-webhook' };
    }
    async handlePixWebhook(body, req) {
        this.logger.log(`Webhook PIX recebido: ${JSON.stringify(body).substring(0, 500)}`);
        try {
            ...
            for (const pix of pixList) {
                ...
                this.logger.log(`Processando PIX: e2eId=${e2eId}, status=${status}, valor=${valor}`);
    ...
    async updateSaleByE2eId(e2eId, updateData) {
        try {
            await this.firestore.setDocument('pix_webhooks', e2eId, updateData);
            this.logger.log(`Webhook salvo em pix_webhooks/${e2eId}: status=${updateData.pixStatus}`);
        }
        catch (e) {
            const msg = e instanceof Error ? e.message : String(e);
...
exports.EfiWebhookController = EfiWebhookController;
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], EfiWebhookController.prototype, "healthCheck", null);
__decorate([
    (0, common_1.Post)('pix'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Body)()),
    ...
    __metadata("design:returntype", Promise)
], EfiWebhookController.prototype, "handlePixWebhook", null);
exports.EfiWebhookController = EfiWebhookController = EfiWebhookController_1 = __decorate([
    (0, common_1.Controller)('api/webhooks/efi'),
    __metadata("design:paramtypes", [typeof (_a = typeof firestore_rest_service_1.FirestoreRestService !== "undefined" && firestore_rest_service_1.FirestoreRestService) === "function" ? _a : Object])
...
const efi_pix_controller_1 = __webpack_require__(/*! ./efi-pix.controller */ "./src/efi/efi-pix.controller.ts");
const efi_webhook_controller_1 = __webpack_require__(/*! ./efi-webhook.controller */ "./src/efi/efi-webhook.controller.ts");
let EfiModule = class EfiModule {
};
exports.EfiModule = EfiModule;
exports.EfiModule = EfiModule = __decorate([
    (0, common_1.Module)({
        controllers: [efi_test_controller_1.EfiTestController, efi_pix_controller_1.EfiPixController, efi_webhook_controller_1.EfiWebhookController],
